...
selenium.open("https://classroom.google.com/u/0/c/MTQ5MjQ5MTEwMDNa")
selenium.label("Start")
selenium.refresh()
boolean trigger = selenium.isElementPresent("xpath=//div[contains(text(), 'Seminar Topic 8: Kalman Filter')]")
...
//selenium.editContent("xpath=//div[contains(@aria-label, \"Add class comment\")]", "<div>CSB15001 &amp; CSB15002, Application of Kalman Filter in Navigation</div>")
